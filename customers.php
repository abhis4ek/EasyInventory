...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'])) {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare('INSERT INTO customers (admin_id, name, street_address, city, pin_code, state, phone, email) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
...
<body>
    <div class="container">
        ...
        <form method="POST" action="customers.php" id="customerForm" novalidate>
            <div class="form-grid">
                    ...
                    <?php if($res && $res->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="customers.php?delete=<?= $r['id'] ?>" 
                                   class="action-link"
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" novalidate>
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        <label for="edit_name">Customer Name <span class="required">*</span></label>
